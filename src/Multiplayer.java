    ...
    public void startGame(Team team1, Team team2) {
        while (finishGame) {
            for (int i = 0; i < 5; i++) {
                ...
                System.out.println("   | |                                                                     | |");
                System.out.println("");
                System.out.print(ANSI_BLUE_BACKGROUND + "shoot:" + "\033[39m" + "\033[49m" + " ");
                shoot = scanner.nextInt();
                System.out.print(ANSI_YELLOW_BACKGROUND + "save:" + "\033[39m" + "\033[49m" + " ");
                ...
                System.out.println("   | |                                                                     | |");
                System.out.println("");
                System.out.print(ANSI_BLUE_BACKGROUND + "save:" + "\033[39m" + "\033[49m" + " ");
                save = scanner.nextInt();
                System.out.print(ANSI_YELLOW_BACKGROUND + "shoot:" + "\033[39m" + "\033[49m" + " ");
                shoot = scanner.nextInt();
